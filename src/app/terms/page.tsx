        ...
        <div className="grid-wrapper py-10 lg:py-24">
          <div className="grid-span-inner">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-slate dark:prose-invert prose-headings:font-light prose-h1:text-3xl prose-h1:lg:text-5xl prose-h1:mb-8 prose-h2:text-2xl prose-h2:font-medium prose-h2:mb-4 prose-h2:mt-8 prose-p:text-muted-foreground prose-p:mb-4">
